...
const EWELL_CONTRACT = '2WCTWEdrVgqgJyoYbuVEDn2RQrfiptUtMUtKvP7TiZp94gUgwJ';
const TOKEN_CONTRACT = '7RzVGiuVWkvL4VfVHdZfQF2Tri3sgLe9U991bohHFfSRZXuGX';
const RPC = 'https://tdvv-public-node.aelf.io';
const CHILD_COUNT = 20;
const MNEMONIC_KEY = 'TOOLS_MNEMONIC_KEY';
const InitialValues = {
  rpcUrl: RPC,
...
export async function initContract(account: any, ewell: string, token: string, rpcUrl: string) {
...
const getAccounts = async (mnemonic: string, childCount = 0) => {
  if (!Wallets[mnemonic]) {

    ...
    <div className={styles['team-of-service']}>
      ...
      <Row gutter={[0, 16]} className={styles['content']}>
        <Col>
          <Row gutter={[0, 8]}>
            <Col>
              {`This website-hosted interface (the "Site") is provided by eBridge Team ("eBridge ", "we", "our", or "us"). The Site provides users with an informational interface relating to a decentralized protocol on the eBridge application that allows users to contract, stake, and pool certain digital assets  (the "Protocol"), subject to the latest features and functions published on the site. The Site is one, but not the exclusive, means of constructing data inputs for purposes of accessing the Protocol. These Terms of Use ("Terms") explain the terms and conditions by which you may access and use the Site. By accessing or using the Site, you signify that you have read, understand, and agree to be bound by these Terms in their entirety. If you do not agree, you are not authorized to access or use the Site and should not use the Site.`}
            </Col>
